...
CREATE TABLE `person` (
  ...
  `ltiid` varchar(255) DEFAULT NULL,
  `userid` varchar(255) NOT NULL,
  `canvasid` varchar(255) DEFAULT NULL,
...
CREATE TABLE `lti_client` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `version` bigint(20) NOT NULL,
  `app_environment` varchar(255) DEFAULT NULL,
...
CREATE TABLE `lti_session` (
  ...
  `resource_link_title` varchar(255) DEFAULT NULL,
  `custom_canvas_enrollment_state` longtext,
  `roles` varchar(255) DEFAULT NULL,
  `resource_link_id` varchar(255) DEFAULT NULL,
  `lis_person_name_family` varchar(255) DEFAULT NULL,
  `user_image` longtext,
  `assignment_id` varchar(255) DEFAULT NULL,
  `custom_canvas_workflow_state` longtext,
  `person_id` bigint(20) NOT NULL,
  `custom_canvas_user_login_id` varchar(255) DEFAULT NULL,
  `lis_person_name_full` varchar(255) DEFAULT NULL,
  `ext_outcome_data_values_accepted` longtext,
  `custom_mtu_client_id` varchar(255) DEFAULT NULL,
  `ext_outcomes_tool_placement_url` longtext,
  `lti_version` varchar(255) DEFAULT NULL,
  `application_name` varchar(255) DEFAULT NULL,
  `custom_mtu_page_name` varchar(255) DEFAULT NULL,
  `launch_presentation_document_target` longtext,
  `ext_outcome_result_total_score_accepted` varchar(255) DEFAULT NULL,
  `expiration_date` datetime NOT NULL,
  `ext_ims_lis_basic_outcome_url` longtext,
  `custom_canvas_assignment_points_possible` varchar(255) DEFAULT NULL,
  `custom_canvas_api_domain` varchar(255) DEFAULT NULL,
  `lis_person_name_given` varchar(255) DEFAULT NULL,
  `tool_consumer_instance_guid` longtext,
  `launch_presentation_locale` longtext,
  `custom_mtu_controller_name` varchar(255) DEFAULT NULL,
  `controller_name` varchar(255) DEFAULT NULL,
  `launch_presentation_height` varchar(255) DEFAULT NULL,
  `lis_person_sourcedid` varchar(255) DEFAULT NULL,
  `lis_result_sourcedid` varchar(255) DEFAULT NULL,
  `last_updated` datetime NOT NULL,
  `custom_canvas_course_id` varchar(255) DEFAULT NULL,
  `tool_consumer_info_version` varchar(255) DEFAULT NULL,
  `custom_mtu_application_name` varchar(255) DEFAULT NULL,
  `action_name` varchar(255) DEFAULT NULL,
  `tool_consumer_instance_name` varchar(255) DEFAULT NULL,
  `custom_canvas_assignment_id` varchar(255) DEFAULT NULL,
  `launch_presentation_return_url` longtext,
  `custom_canvas_assignment_title` varchar(255) DEFAULT NULL,
  `user_id` varchar(255) DEFAULT NULL,
  `lti_refreshable_token` varchar(255) DEFAULT NULL,
  `lti_message_type` varchar(255) DEFAULT NULL,
  `ext_outcome_submission_submitted_at_accepted` varchar(255) DEFAULT NULL,
  `custom_mtu_lti_token_required` bit(1) DEFAULT NULL,
  `lis_outcome_service_url` longtext,
  `context_label` varchar(255) DEFAULT NULL,
  `ext_roles` varchar(255) DEFAULT NULL,
  `lti_access_token` varchar(255) DEFAULT NULL,
  `custom_canvas_user_id` varchar(255) DEFAULT NULL,
  `ext_lti_assignment_id` varchar(255) DEFAULT NULL,
  `tool_consumer_instance_contact_email` varchar(255) DEFAULT NULL,
  `launch_presentation_width` varchar(255) DEFAULT NULL,
  `context_title` varchar(255) DEFAULT NULL,
  `lti_token_request_state` varchar(255) DEFAULT NULL,
  `custom_mtu_canvas_role` varchar(255) DEFAULT NULL,
  `lis_person_contact_email_primary` varchar(255) DEFAULT NULL,
  `lti_token` varchar(255) DEFAULT NULL,
  `tool_consumer_info_product_family_code` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
